...
import com.camerash.skygear.chat.ui.holder.*
import com.camerash.skygear.chat.ui.model.*
...
//        this.messageListAdapter?.startListening()
    }

    open fun stopListeningScroll() {
//        this.messageListAdapter?.stopListening()
    }
    ...
    class ContentTypeChecker : MessageHolders.ContentChecker<Message> {
        ...
        override fun hasContentFor(message: Message?, type: Byte): Boolean {
            ...
            return when (type) {
                VoiceMessageType -> VoiceMessage.isVoiceMessage(message)
                else -> false
            }
        }
    }
