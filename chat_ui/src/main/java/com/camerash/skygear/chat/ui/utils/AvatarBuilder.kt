package com.camerash.skygear.chat.ui.utils
...
class AvatarBuilder(
    ...
    companion object {
        ...
        fun avatarUriForName(name: String, backgroundColor: Int, initialTextColor: Int) =
                "$Scheme://user?name=$name&backgroundColor=$backgroundColor&initialTextColor=$initialTextColor"
    }

    constructor() : this(
            DefaultAvatarWidth,
            DefaultAvatarHeight,
            DefaultAvatarTextSize
    )
